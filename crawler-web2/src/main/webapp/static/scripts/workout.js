...
workoutApp.workout.StrengthItems = [
	...
	{part: "前臂", epart: "Forme Arms", type: "free", id: "sth-6-1", name: "杠铃腕弯举", ename: "", 
		pim: ["6-2"], min: [], ext: []},
	{part: "前臂", epart: "Forme Arms", type: "free", id: "sth-6-6", name: "单臂哑铃腕弯举", ename: "", 
		pim: ["6-2"], min: [], ext: []},
	{part: "前臂", epart: "Forme Arms", type: "free", id: "sth-6-6", name: "背后杠铃腕弯举", ename: "", 
		pim: ["6-2"], min: [], ext: []},
	{part: "前臂", epart: "Forme Arms", type: "free", id: "sth-6-1", name: "反握杠铃腕弯举", ename: "", 
		pim: ["6-1"], min: [], ext: []},
	{part: "前臂", epart: "Forme Arms", type: "free", id: "sth-6-1", name: "反握哑铃腕弯举", ename: "", 
		pim: ["6-1"], min: [], ext: []},
	{part: "前臂", epart: "Forme Arms", type: "free", id: "sth-6-1", name: "反握杠铃弯举", ename: "", 
		pim: ["6-1"], min: [], ext: []},
